...
let
  nixos-hardware = builtins.fetchTarball {
    url =
      "https://github.com/NixOS/nixos-hardware/archive/0471accf8d0a8210b31d947497d179ecc99e0021.tar.gz";
    sha256 = "0k8asy55nd9cn7vmvdpqm8zmpjc3zwhgd51cdndj4dg4y7dyyxqw";
  };
in { config, pkgs, lib, ... }:
